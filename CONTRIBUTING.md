...
The MLVideoPlayer maintainers takes security seriously.
...
See [CODE_OF_CONDUCT.md](https://github.com/micheltlutz/MLVideoPlayer/blob/master/CODE_OF_CONDUCT.md) for details.
